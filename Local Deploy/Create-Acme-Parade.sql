...
use database `Acme-Parade`;

create user 'acme-user'@'%' identified by password '*4F10007AADA9EE3DBB2CC36575DFC6F4FDE27577';
create user 'acme-manager'@'%'identified by password '*FDB8CD304EB2317D10C95D797A4BD7492560F55F';

grant select, insert, update, delete	on `Acme-Parade`.* 
	to 'acme-user'@'%';

grant select, insert, update, delete, create, drop, references, index, alter,create temporary tables, lock tables, create view, create routine,alter routine, execute, trigger, show view on `Acme-Parade`.* 
	to 'acme-manager'@'%';
...
INSERT INTO `system_config` VALUES (27,0,21,'https://imgur.com/vZI1Sft',12.23,1,10,'Acme Parade','+34','Welcome to Acme Parade, the site to organise your parades.','¡Bienvenidos a Acme Parade!  Tu sitio para organizar procesiones.');
